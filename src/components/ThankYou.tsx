    ...
    <div className="min-h-screen bg-gradient-to-b from-indigo-900 via-purple-900 to-indigo-950 flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-4 sm:px-8 py-12 overflow-y-auto">
        <div className="text-center max-w-6xl mx-auto w-full">
          ...
          <div className="mt-12 bg-white/10 backdrop-blur-sm rounded-2xl p-6 sm:p-8 lg:p-10 border border-white/20" style={{ isolation: 'isolate' }}>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white/5 rounded-xl p-4 sm:p-6">
                <p className="text-white mb-4 text-base sm:text-lg font-semibold">
                  📧 Your confirmation email will look like this:
                </p>
                <div className="bg-white rounded-lg p-2 sm:p-3 shadow-xl" style={{ isolation: 'isolate' }}>
